...
/**
 * Complex enum representing subscription tiers. Has fields, constructor, methods, and a static
 * block.
 */
public enum SubscriptionTier {
  ...
  // Constructor
  SubscriptionTier(
      String displayName, double monthlyPrice, int maxDownloads, boolean offlineAccess) {
