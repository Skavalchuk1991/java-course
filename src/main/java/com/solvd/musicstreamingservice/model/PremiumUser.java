...
/** PremiumUser is a special type of User It extends User and adds extra functionality */
public class PremiumUser extends User {
  ...
  /** Constructor for PremiumUser Calls parent constructor using super() */
  public PremiumUser(
      int id, String username, String email, Subscription subscription, int downloadLimit) {
