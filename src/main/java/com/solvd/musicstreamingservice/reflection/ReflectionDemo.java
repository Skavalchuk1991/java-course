...
public class ReflectionDemo {
  ...
  public static void run() {
    ...
    try {
      ...
      Song reflectedSong =
          ctor.newInstance(
              100, "Reflection Song", 180, "DJ Reflect", "Mirror Album", reflectedGenre);
    ...
    try {
      ...
      Constructor<Song> ctor =
          clazz.getDeclaredConstructor(
              int.class, String.class, int.class, String.class, String.class, Genre.class);
      Song reflectedSong =
          ctor.newInstance(101, "Dynamic Call", 200, "Reflector", "Meta Album", reflectedGenre);
    ...
    Song annotatedSong =
        new Song(200, "Annotated Song", 240, "Annotation Artist", "Meta Album", annotationGenre);
