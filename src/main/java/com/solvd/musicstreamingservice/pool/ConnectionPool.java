...
/**
 * Thread-safe Connection Pool with lazy initialization (Singleton). Uses BlockingQueue from
 * java.util.concurrent. getConnection() blocks if no connections available.
 */
